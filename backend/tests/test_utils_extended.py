"""
Extended tests for utility functions to increase coverage.

Tests cover:
- get_client_ip (header parsing)
- update_last_seen (throttling and database updates)
- verify_token (Redis caching, PocketBase fallback, token refresh)
"""
...
from priotag.utils import get_client_ip, update_last_seen, verify_token
