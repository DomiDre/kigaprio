	...
	>
		<div class="container mx-auto max-w-6xl px-4 py-8">
			...
			<div class="mb-6 flex items-center justify-end gap-3">
				<a
					href="/dashboard"
					class="rounded-lg bg-white dark:bg-gray-700 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors duration-200 flex items-center gap-2"
				>
				...
				{#if $isAdmin}
					<a
						href="/admin"
						class="rounded-lg bg-purple-600 hover:bg-purple-700 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors duration-200 flex items-center gap-2"
					>
						<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
